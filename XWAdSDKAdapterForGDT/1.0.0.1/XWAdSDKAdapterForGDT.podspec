Pod::Spec.new do |s|
  ...
  s.homepage = "https://gitee.com/xiaowoteam/XWAdSDKAdapterForGDT.framework"
  ...
  s.source = { :git => 'https://gitee.com/xiaowoteam/XWAdSDKAdapterForGDT.framework.git', :tag => s.version.to_s }
