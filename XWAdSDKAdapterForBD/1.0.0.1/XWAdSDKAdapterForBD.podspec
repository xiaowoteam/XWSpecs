Pod::Spec.new do |s|
  ...
  s.homepage = "https://gitee.com/xiaowoteam/XWAdSDKAdapterForBD.framework"
  ...
  s.source = { :git => 'https://gitee.com/xiaowoteam/XWAdSDKAdapterForBD.framework.git', :tag => s.version.to_s }
