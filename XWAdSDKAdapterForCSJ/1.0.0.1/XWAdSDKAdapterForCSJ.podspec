Pod::Spec.new do |s|
  ...
  s.homepage = "https://gitee.com/xiaowoteam/XWAdSDKAdapterForCSJ.framework"
  ...
  s.source = { :git => 'https://gitee.com/xiaowoteam/XWAdSDKAdapterForCSJ.framework.git', :tag => s.version.to_s }
