Pod::Spec.new do |s|
  ...
  s.homepage = "https://github.com/xiaowoteam/XWAdSDKAdapterForSIG.framework"
  ...
  s.source = { :git => 'https://github.com/xiaowoteam/XWAdSDKAdapterForSIG.framework.git', :tag => s.version.to_s }
