Pod::Spec.new do |s|
  ...
  s.homepage = "https://gitee.com/xiaowoteam/XWAdSDKAdapterForLY.framework"
  ...
  s.source = { :git => 'https://gitee.com/xiaowoteam/XWAdSDKAdapterForLY.framework.git', :tag => s.version.to_s }
