Pod::Spec.new do |s|
  ...
  s.homepage = "https://github.com/xiaowoteam/XWAdSDKAdapterForIQY.framework"
  ...
  s.source = { :git => 'https://github.com/xiaowoteam/XWAdSDKAdapterForIQY.framework.git', :tag => s.version.to_s }
